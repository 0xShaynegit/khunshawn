# Khun Shawn – Technical Specification

**Project:** Khun Shawn Personal Brand & AI Systems Website
**URL:** khun-shawn.com
...
/khun-shawn
  ...
  /pages
    /about.html            # About Khun Shawn & background
    /services.html         # AI strategy, content systems, coaching
  /images
...
- Images: `src="images/khun-shawn-hero.webp"`
...
```json
{
  ...
  "@type": "Person",
  "name": "Khun Shawn",
  "url": "https://khun-shawn.com",
  "image": "https://khun-shawn.com/images/khun-shawn-hero.webp",
  "sameAs": [
    "https://www.youtube.com/@KhunShawn",
    "https://www.instagram.com/khunshawn/",
    "https://www.facebook.com/MysteryMrR/"
  ],
  "jobTitle": "AI Systems Architect & Creator Revenue Strategist",
  "description": "Build Systems. Create Impact. Stay Aligned."
}
```
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://khun-shawn.com/</loc>
    <priority>1.0</priority>
  </url>
  <url>
    <loc>https://khun-shawn.com/pages/services.html</loc>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://khun-shawn.com/pages/about.html</loc>
...
User-agent: *
Allow: /
Sitemap: https://khun-shawn.com/sitemap.xml
```
...
- **Naming:** Descriptive, lowercase, hyphens (e.g., `khun-shawn-hero.webp`, `ai-systems-diagram.webp`)
- **Sizes:**
...
- Email: shayneinthailan@gmail.com (or preferred contact email)
- Booking: Calendly link for strategy sessions
...
- **Social:** YouTube (@KhunShawn), Instagram (@khunshawn), Facebook (@MysteryMrR)
...
- Enter:
  - **Name:** Khun Shawn
  - **Email:** shayneinthailan@gmail.com
  - **Reply-to:** shayneinthailan@gmail.com (optional)
...
- **Port:** 587 (TLS)
- **Username:** shayneinthailan@gmail.com (actual Gmail account)
- **Password:** [App Password from Step 2, 16 characters]
- **From Email:** shayneinthailan@gmail.com (or custom domain alias)
- **Sender Name:** Khun Shawn
...
GMAIL_SMTP_PORT=587
GMAIL_USERNAME=shayneinthailan@gmail.com
GMAIL_PASSWORD=[16-char-app-password]
GMAIL_FROM_EMAIL=shayneinthailan@gmail.com
GMAIL_FROM_NAME=Khun Shawn
CONTACT_TO_EMAIL=shayneinthailan@gmail.com
```
...
- Primary CTA: "Start a Strategy Session" (links to Calendly)
- Secondary CTA: "Explore AI Systems" or "Learn More"
...
```
1. Go to Pages > khun-shawn > Settings
...
Name: GMAIL_USERNAME
Value: shayneinthailan@gmail.com
    ...
    return new Response(
      ...
      }),
      {
        ...
        headers: {
          ...
          'Access-Control-Allow-Origin': 'https://khun-shawn.com'
        }
      }
    );
...
**Primary Maintainer:** Khun Shawn
**Repository:** GitHub (khun-shawn/khun-shawn or similar)
