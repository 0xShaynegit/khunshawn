# Khun Shawn – Website Handover & Maintenance Guide

**Project:** Khun Shawn Personal Brand Website
**URL:** khun-shawn.com
**For:** Khun Shawn
...
This guide explains how to update, maintain, and manage your AI strategy and creator systems website using:
...
- `pages/about.html` – About Khun Shawn, background, philosophy
- `pages/services.html` – AI strategy, content systems, personal transformation services
...
2. Choose **Open Folder** and select the `khun-shawn` folder.
3. You should see:
...
- ✅ `khun-shawn-hero.webp` – Hero section image
- ✅ `khun-shawn-logo-banner.webp` – Logo/branding banner
- ✅ `khun-shawn-portrait.webp` – Professional portrait
...
```html
<img src="images/khun-shawn-portrait.webp" alt="Khun Shawn, AI systems architect and creator revenue strategist">
```

From any file inside `/pages`:

```html
<img src="../images/khun-shawn-logo-banner.webp" alt="Khun Shawn AI systems and creator branding logo">
```
...
- **AI Strategy** – AI diagnostics, system implementation, workflow optimization
- **Content Systems** – Creator infrastructure, content frameworks, audience building
- **Personal Transformation** – Mirrored Path philosophy, coaching, alignment
...
```html
<a href="https://calendly.com/khunshawn/" target="_blank">Book a Strategy Call</a>
```
...
```html
<a href="https://www.youtube.com/@KhunShawn" target="_blank">YouTube</a>
<a href="https://www.instagram.com/khunshawn/" target="_blank">Instagram</a>
<a href="https://www.facebook.com/MysteryMrR/" target="_blank">Facebook</a>
```
...
2. Within 1–2 minutes the change is visible on `https://khun-shawn.com`.
...
**Happy maintaining your creator systems brand website!**
